...
func (in *TextField) Update(gtx layout.Context, th *material.Theme, hint string) {
	...
	var (
		...
		borderColor        = component.WithAlpha(th.Fg, 128)
		borderColorHovered = component.WithAlpha(th.Fg, 221)
		borderColorActive  = th.ContrastBg
...
func (in *TextField) Layout(gtx layout.Context, th *material.Theme, hint string) layout.Dimensions {
