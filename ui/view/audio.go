...
var (
	...
	timestamp                 uint16
	mute                      bool
	micOffButton              = &IconButton{Theme: fonts.DefaultTheme, Icon: icons.MicOffIcon, VGData: icons.AVMicOff, Enabled: true, Hidden: true}
	audioMakeButton           = &IconButton{Theme: fonts.DefaultTheme, Icon: icons.AudioCallIcon, VGData: icons.CommunicationPhone, Enabled: true}
	audioAcceptButton         = &IconButton{Theme: fonts.DefaultTheme, Icon: icons.AudioCallIcon, VGData: icons.CommunicationPhone, Enabled: true, Mode: Accept}
...
func NewAudioIconStack(streamConfig audio.StreamConfig) *IconStack {
	...
	var audioDeclineButton = &IconButton{Theme: fonts.DefaultTheme, Icon: icons.AudioCallIcon, VGData: icons.CommunicationPhone, Enabled: true, Mode: Decline}
